...
ActiveRecord::Schema[8.0].define(version: 2025_08_22_092516) do
  ...
  create_table "hotspotsessions", force: :cascade do |t|
    t.string "session_id", null: false
    t.text "data"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["session_id"], name: "index_hotspotsessions_on_session_id", unique: true
    t.index ["updated_at"], name: "index_hotspotsessions_on_updated_at"
  end
